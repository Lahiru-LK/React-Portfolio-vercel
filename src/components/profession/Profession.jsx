      ...
      <div className="flex flex-col justify-between h-fit md:pe-8 lg:pe-35.75 max-md:text-center my-auto">
        ...
        <div className="mt-6 text-[14px]">
          <p className="text-xs sm:text-lg font-normal text-gray-400 mb-4">
            I specialize in full-stack development, UI/UX design, and cloud
            solutions. My expertise covers building scalable web apps, intuitive
            interfaces, and seamless user experiences.
          </p>
          <p className="text-xs sm:text-lg font-normal text-gray-400">
            My approach combines creativity, technical skill, and modern workflows
            to deliver solutions that are visually appealing, robust, and
            user-focused.
          </p>
        </div>
        <a
